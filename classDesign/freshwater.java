public class freshwater extends ecosystems {
	private String name;
	private String type;
	//constructor
	public freshwater(String name, String type) {
		super(name, type);
	}
	//getters
	...
	public void freshwater(String name){
		System.out.println("This method will return information on Ecosystems of Main Type, Freshwater.");
	}
}
