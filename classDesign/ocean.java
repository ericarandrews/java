public class ocean extends ecosystems {
	private String name;
	private String type;
	//constructor
	...
	public void ocean(String name){
		System.out.println("This method will return information on Ecosystems of Main Type, Ocean.");
	}
}
